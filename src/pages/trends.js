      ...
      <div className="bg-[#cce5f3] flex flex-col items-center">
        ...
        <div className="w-[68%] bg-[#eef4fb] relative ml-[2%] border-l-4 border-[#0c2e39]">
          ...
          <div className="flex flex-col space-y-6 m-6 ">
            ...
            <p>
              The pandemic accelerated a massive shift toward remote and hybrid
              work. In 2021, about one in four employees in Greater Philadelphia
              worked from home at least half of the time, which reduced both
              solo driving and public transit use.
            </p>
            <p>
              Though offices and schools have since reopened, hybrid work
              remains common, which has changed how people use transportation,
              air quality patterns, and transit agency finances. Congestion has
              returned to pre-pandemic levels but is now spread more evenly
              throughout the day, while transit ridership remains roughly{" "}
              <span className="font-bold">30% below 2019 levels.</span>
            </p>
            <p>
              Philadelphia’s affordability and access to the Northeast Corridor
              have also attracted new remote workers, driving a{" "}
              <span className="font-bold">surge in business formations</span>,
              an increase of 94% regionally and more than 160% in the city since
              2020. As employers adjust hybrid policies and workers reassess
              where they live and how they commute, these changes continue to
              reshape travel demand, housing markets, and economic opportunity
              across the region.
            </p>
        ...
        <div className="w-[68%] bg-[#eef4fb] relative ml-[2%] border-l-4 border-[#0c2e39]">
          ...
          <div className="flex flex-col space-y-6 m-6 ">
            ...
            <p>
              ...
              <span className="font-bold">optimize traffic flow,</span> improve{" "}
              <span className="font-bold">transit reliability,</span> and
              monitor{" "}
              <span className="font-bold">infrastructure conditions</span> in
              real time.
            </p>
            <p>
              For Greater Philadelphia, AI offers new tools to modernize
              transportation systems, improve safety, and support smarter land
              use and energy planning. At the same time, it raises important
              questions about privacy, copyright, bias, transparency, and energy
              use, all challenges that need to be addressed.
            </p>
            <h4 className="mx-auto text-[#16819a] font-bold text-lg">
        ...
        <div className="w-[68%] bg-[#eef4fb] relative ml-[2%] border-l-4 border-[#0c2e39]">
          ...
          <div className="flex flex-col space-y-6 m-6 ">
            <p>
              ...
              expanding access to transportation and redefining how people move
              through the region.
            </p>
            <p>
              Governments and private partners are testing{" "}
              <strong>ridesharing, microtransit,</strong> and{" "}
              <strong>automated vehicle</strong> programs to improve connections
              in areas underserved by traditional transit. DVRPC and local
              partners are exploring how these technologies can improve access
              to jobs, serve people with disabilities, and connect residents to
              essential services.
            </p>
            <p>
              Examples include GOTrenton!, the Navy Yard Automated Shuttle, and
              Conshohocken Cab. While these services show promise, they can be
              expensive and generally complement, rather than replace,
              fixed-route transit options.
            </p>
          </div>
        </div>
        <div className="w-[68%] bg-[#eef4fb] relative ml-[2%] border-l-4 border-[#0c2e39]">
          <div className="flex items-center w-full bg-[#179650] p-4 relative">
            <Dot width="3%" className="absolute -left-[1.5%] top-5" />
            <div className="w-full ml-[1.5%] flex flex-col space-y-4 text-white">
              ...
              <p className="text-lg">
                Tracking Progress presents easy-to-use indicators that show how
                the region is advancing toward the Plan’s vision. Current trends
                show improvement in bridge conditions, business growth, and
                housing production, but continuing challenges in income
