          ...
          <div className="border-l-4 border-[#0c2e39] md:w-[68%] mx-auto">
            ...
            <div className="flex flex-col space-y-4 md:p-6 p-2 md:pt-0">
              ...
              <p>
                ...
                occupancy. Congestion has returned to pre-pandemic levels but is
                now spread more evenly throughout the day, while transit
                ridership remains roughly <strong>30% below 2019 levels</strong>
                .
              </p>
              <p>
              ...
              <h4 className="mx-auto text-[#16819a] font-bold text-lg font-[scriptorama-markdown-jf]">
                MEANS OF TRANSPORTATION TO WORK BY MODE SHARE
              </h4>
              <img
                className="md:w-1/2 mx-auto"
                alt="Line chart showing commute mode share from 2010 to 2023. Driving alone remained the dominant commute mode, holding steady around 70% through 2019, dropping to about 60% in 2021 during the pandemic, then rebounding to roughly 65% by 2023. Working from home was minimal before 2020 at under 10%, spiked sharply to nearly 30% in 2021, then declined to about 19% in 2023 while remaining much higher than pre-pandemic levels. Public transit use declined from about 13% in 2010 to around 10% in 2023, with the steepest drop occurring after 2020. Carpooling increased gradually from about 10% to 15% by 2023. Walking, biking, and other commute modes remained relatively low throughout the period, generally below 5%. Decorative icons of a car, bus, and person on a computer appear near the related trend lines."
                src={TransportationMeans}
              />
              <small className="md:mx-auto">
                Source: U.S. Census Bureau’s American Community Survey Five-Year
                Estimates
                <br /> *No data available for 2020 due to the COVID-19 pandemic.
              </small>
              <small></small>
            </div>
          </div>
          ...
          <div className="border-l-4 border-[#0c2e39] md:w-[68%] mx-auto">
            ...
            <div className="flex flex-col space-y-4 md:p-6 md:pt-0 p-2">
              ...
              <p>
                ...
                <Tooltip
                  title="Ridesharing refers to services that match passengers with drivers  (often through an app) to provide on-demand trips, sometimes shared with other riders heading in the same direction."
                  position="top"
                  trigger="click"
                >
                  <span className="underline hover:cursor-pointer">
                ...
                ,{" "}
                <Tooltip
                  title="Microtransit is a flexible, on-demand public or private transportation service that uses smaller vehicles and dynamic routing to serve areas or travel needs not well covered by fixed bus or rail routes."
                  position="top"
                  trigger="click"
                >
                  <span className="underline hover:cursor-pointer">
                ...
                , and{" "}
                <Tooltip
                  title="Automated vehicles (or autonomous vehicles) describe a car, shuttle, or other vehicle that uses sensors, software, and artificial intelligence to operate with limited or no human driver input."
                  position="top"
                  trigger="click"
                >
                  <span className="underline hover:cursor-pointer">
                ...
                traditional transit. DVRPC and local partners are exploring how
                these technologies can improve access to jobs, serve people with
                disabilities, and connect residents to essential services.
              </p>
              <p>
        ...
        <div className="w-full bg-[#cbe5f3] relative">
          <div className="md:w-[68%] mx-auto">
            ...
            <div className="flex flex-col space-y-4 md:p-6 md:pt-0 p-2">
              ...
              <p className="text-lg">
                Tracking Progress highlights indicators that show how the region
                is advancing toward the Plan’s vision. Current trends show
                improvement in{" "}
                <strong>
