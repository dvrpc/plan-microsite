            ...
            <div className="w-[68%] relative mx-auto border-l-4 border-[#063446]">
              <div className="flex w-full p-4 relative flex-col">
                ...
                <p className="ml-[1.5%]">
                  ...
                  includes transit, roadways, biking and walking paths, freight
                  rail, and an international port and airport. However, many
                  facilities are aging and need modernization. Investments in
                  safety, active transportation, and transit will improve
                  health, air quality, and access to the region. The Plan
                  supports Vision Zero to eliminate serious crashes and promotes
                  walking and biking, highlighted by investment in the Circuit
                  Trails network, and transit that connects urban, suburban, and
                  rural communities.
                </p>
                ...
                <div className="ml-[1.5%]">
                  ...
                  <p>
                    This looks like increased safety and access to affordable
                ...
                <div className="ml-[1.5%]">
                  ...
                  <p>
                    This looks like reliable, predictable trips made possible by
                    sustained investments in transit, roads, and bridges. Fully
                    funded operations and maintenance ensure fewer disruptions
                    and safer conditions. Transparent budgeting and long-term
                    capital planning support confidence in the system.
                  </p>
                </div>
                <div className="ml-[1.5%]">
                  <Dot width="3%" className="absolute -left-[1.5%]" />
                  ...
                  <p>
                    This looks like fewer people driving alone and more people
                    traveling by resource-efficient mobility options, such as
                    walking, biking, and taking transit, and reduced air
                    pollution through the use of renewable and alternative fuels
          ...
          <TabPanel>
            ...
            <div className="w-[68%] relative mx-auto border-l-4 border-[#063446]">
              <div className="flex w-full p-4 relative flex-col">
                <Dot width="3%" className="absolute -left-[1.5%]" />
                <p className="ml-[1.5%]">
                  Greater Philadelphia’s economy benefits from its location
                  along the Northeast Corridor, diverse industries, and
                  world-class educational and healthcare institutions. To reach
                  its full potential, the region must remain a place where
                  workers want to live and businesses can grow. Expanding access
                  to opportunity through workforce development, innovation, and
                  entrepreneurship will help families achieve financial mobility
                  and position Greater Philadelphia as a thriving, resilient
                ...
                <div className="ml-[1.5%]">
                  ...
                  <p>
                    This looks like expanded economic mobility through access to
                ...
                <div className="ml-[1.5%]">
                  ...
                  <p>
                    This looks like the impacts of global market forces,
                    economic shocks, and extreme weather risks are anticipated
                    and mitigated through sectoral balance and connectivity.
                    Businesses and workers, especially those who have been
                    historically disenfranchised, are able to recover quickly.
                  </p>
                </div>
                <div className="ml-[1.5%]">
                  <Dot width="3%" className="absolute -left-[1.5%]" />
                  ...
                  <p>
                    This looks like goods production and growth at rates that
                    meet current needs without negative environmental or social
                    impacts in the present or future.
                  </p>
                </div>
                <Link
            ...
            <div className="w-[68%] relative mx-auto border-l-4 border-[#063446]">
              <div className="flex w-full p-4 relative flex-col">
                ...
                <p className="ml-[1.5%]">
                  ...
                  to deliver services efficiently. They offer a mix of housing
                  types and uses, affordable options, and safe, convenient ways
                  to walk, bike, and ride transit. With well-maintained public
                  spaces and strong civic infrastructure, these communities
                  promote active, healthy living and create vibrant, resilient
                  places for all.
                </p>
                ...
                <div className="ml-[1.5%]">
                  ...
                  <p>
                    This looks like affordable and socioeconomically integrated
                    communities that are safe, accessible, and built for all
                    ages. Growth is accommodated without the displacement of the
                    existing population, which allows all residents to benefit.
                  </p>
                </div>
                <div className="ml-[1.5%]">
                  <Dot width="3%" className="absolute -left-[1.5%]" />
                  ...
                  <p>
                    This looks like strong civic infrastructure and social
                    cohesion that help residents withstand, adapt to, and
                    recover from adverse situations, such as extreme weather
                    events or social disruptions.
                  </p>
                </div>
                <div className="ml-[1.5%]">
                  <Dot width="3%" className="absolute -left-[1.5%]" />
                  ...
                  <p>
                    This looks like growth focused in mixed-use, walkable
                    Centers that make efficient use of infrastructure, provide
                    access to essential services, and consume less land and
                    other resources.
                  </p>
                </div>
                <Link
            ...
            <div className="w-[68%] relative mx-auto border-l-4 border-[#063446]">
              <div className="flex w-full p-4 relative flex-col">
                ...
                <p className="ml-[1.5%]">
                  ...
                  natural areas—forests, wetlands, tree canopy, parks, and green
                  infrastructure—can improve air and water quality, provide
                  wildlife habitat, reduce heat, and support community health.
                ...
                <div className="ml-[1.5%]">
                  ...
                  <p>
                    This looks like prioritized and expanded use of nature-based
                    solutions for adapting to intense precipitation and high
                    heat events in communities.
                  </p>
                </div>
                <div className="ml-[1.5%]">
                  <Dot width="3%" className="absolute -left-[1.5%]" />
                ...
                <div className="ml-[1.5%]">
                  ...
                  <p>
                    This looks like clean water and air, productive soil, and
                    healthy ecosystems, as well as access to parks, open space,
                    natural areas, and outdoor recreation for current and future
                    generations.
                  </p>
                </div>
                <Link
            ...
            <div className="w-[68%] relative mx-auto border-l-4 border-[#063446]">
              <div className="flex w-full p-4 relative flex-col">
                ...
                <p className="ml-[1.5%]">
                  ...
                  services will increase comfort and quality of life, reduce
                  utility cost burdens, and improve the performance of the
                  buildings, vehicles, and infrastructure systems on which we
                  all depend.
                </p>
                ...
                <div className="ml-[1.5%]">
                  <Dot width="3%" className="absolute -left-[1.5%]" />
                  <h2 className="text-lg font-bold">
                    <b>1.</b> Access to clean and affordable heating, cooling,
                    and power services for every household, business, and
                    institution in the region.
                  </h2>
                  <p>
                    This looks like reliable and affordable utility services,
                    including broadband, electricity, natural gas, water, and
                    wastewater.
                  </p>
                </div>
                <div className="ml-[1.5%]">
                  ...
                  <p>
                    This looks like reliable access to heating, cooling, and
                    power for households and businesses. Systems are prepared
                    for extreme weather events and related impacts.
                  </p>
                </div>
                <div className="ml-[1.5%]">
                  <Dot width="3%" className="absolute -left-[1.5%]" />
                  ...
                  <p>
                    This looks like reduced local air pollution through
                    efficient land use, transportation, and building systems, as
                    well as generating power with cleaner fuels.
                  </p>
                </div>
                <Link
        ...
        <div className="text-[#dfebf5] bg-[#063446] w-full flex flex-col relative px-12 py-6 mt-[10%]">
          <div className="w-[70%] mx-auto space-y-4">
            ...
            <p className="text-2xl pb-0 z-50">
              ...
              Economy, Communities, Environment, and Infrastructure & Utility
